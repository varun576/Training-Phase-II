...
namespace ConsoleApp3
{
    class Program
    {
        ...
        { // See https://aka.ms/new-console-template for more information
            ...
            GenericCollection s = new GenericCollection();
            s.Find();
            Book book1 = new (1, "The India Story", "Bimal Jalal", false);
            Book book2 = new (2, "Listen to Your Heart: The London Adventure", "Ruskin Bond", true);
            Book book3 = new (1003, "Business of Sports: The Winning Formula for Success", "Vinit Karnik", false);
            Book book4 = new (1004, "A Place Called Home", "Preeti Shenoy", true);
